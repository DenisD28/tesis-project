...
export default function TextareaForm({dataTextarea}: {dataTextarea: TextareaFormProps}) {
  return (
    <div className="flex justify-center items-center flex-col p-2">
        ...
        <textarea className="w-full h-36 rounded border-2 border-[#ddd] px-4 font-medium bg-slate-100 text-[#555]" name={dataTextarea.name} id={dataTextarea.name} placeholder={dataTextarea.placeholder}></textarea>
    </div>
  )
}

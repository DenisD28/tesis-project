...
export default function InfoSaleSelected({Data, fnDeleteInput}: InfoSaleSelectedProps) {
  return (
    <section className="bg-gray-100 p-4 rounded-md shadow-md col-span-12 m-2 [&>p]:mb-2">
      ...
      <p>
        <span className="font-bold">Producción:</span> {Data.produccion}
      </p>
      <p>
        <span className="font-bold">Disponibilidad:</span> {Data.disponibilidad}
      </p>
      <p>
        <span className="font-bold">Costo:</span> {Data.costo}
      </p>
      <p>

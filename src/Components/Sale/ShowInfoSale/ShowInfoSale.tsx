  ...
  return (
    <article className='bg-slate-100 w-full rounded-md p-4 flex justify-between items-center border-2'>
        <section>
            ...
            <p><b>Precio:</b> C${Data.precio.toFixed(2)}</p>
            <p><b>ID de entrada:</b> {Data.product_input.id}</p>
            <p><b>Fecha de produccion:</b> {Data.product_input.fecha}</p>
            <p><b>Costo de produccion:</b> C${Data.product_input.costo.toFixed(2)}</p>
        </section>
        <section>

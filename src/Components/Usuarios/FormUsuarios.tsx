    ...
    return (
        <form onSubmit={(e) => handleSubmit(e)} className='grid grid-cols-1 md:grid-cols-2 grid-rows-2'>
            ...
            <div className="flex justify-center items-center flex-col p-2">
                ...
                <input className="w-full h-10 rounded border-2 border-[#ddd] px-4 font-medium bg-slate-100 text-[#555]" type="text" name="name" placeholder="Escribe el nombre de la persona" onChange={handleInputChange} value={formProducto.name} />
            </div>
            <div className="flex justify-center items-center flex-col p-2">
                ...
                <input className="w-full h-10 rounded border-2 border-[#ddd] px-4 font-medium bg-slate-100 text-[#555]" type="text" name="username" placeholder="Escribe su nombre de usuario" onChange={handleInputChange} value={formProducto.username} />
            </div>
            <div className="flex justify-center items-center flex-col p-2">
            ...
            <div className="flex justify-center items-center flex-col p-2">
                ...
                <select onChange={handleSelectChange} className="w-full h-10 rounded border-2 border-[#ddd] px-4 font-medium bg-slate-100 text-[#555]" name="organization" id="municipality_id" value={formProducto.organization}>

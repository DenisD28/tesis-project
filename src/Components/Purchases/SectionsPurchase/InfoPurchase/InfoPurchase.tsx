...
export default function InfoPurchase({statusInfo, provider, numberBill, total, handleSubmit}: InfoPurchaseProps) {
  return (
    <div className='w-full my-4 grid grid-cols-12 border-2 rounded-md p-8 gap-2'>
        ...
        </h1>
        {
            ...
            :   <DataPurchase provider={provider} numberBill={numberBill} total={total} />
        }
    </div>
  )
}

...
export const IngresoProducto = () => {
    const [formProducto, setFormProduct] = useState<inven>({ type: "", stock_min: 0, unit_of_measurement: "", code: "", description: "" })
    ...
    const cancelar = () => {
        setFormProduct({ type: "", stock_min: 0, unit_of_measurement: "", code: "", description: "" })
    }

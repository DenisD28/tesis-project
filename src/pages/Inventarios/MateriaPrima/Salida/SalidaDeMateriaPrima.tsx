...
export const SalidaDeMateriaPrima: React.FC = () => {
    ...
    const IngresarCantidad = (dato: any) => {
        setDato(dato)
        setIsOpen(false)
        setIsOpenForm(true)
    }
    ...
    return (
        <>
            ...
            {
                isOpen && (
                    <ModalInventario fnAgregar={IngresarCantidad}
                        setIsOpen={setIsOpen} />
                )
            }
            ...
            {
                isOpenForm && (
                    <ModalInput setcantidades={setCantidades} cantidades={cantidadesUsadas} setIsOpenForm={setIsOpenForm} dato={dato} SeleccionarDetalle={SeleccionarDetalle} />
                )
            }

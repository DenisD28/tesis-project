...
export const AddInventario = () => {
    ...
    // Dato extra, este no va en la consulta
                ...
                <form onSubmit={(e) => handleSubmit(e)} className='grid grid-cols-1 md:grid-cols-2 grid-rows-2'>
                    ...
                    <InputsForm
                        DataInputs={{
                            ...
                            value: location || "",
                            type: "text",
                            placeholder: "Escribe la locacion del producto",
                            isRequire: false,
                            isDisabled: false,
                            fnChange: setLocation,
                        }}
                    />
                    <InputsForm
                        DataInputs={{
                            ...
                            value: lot_number || "",
                            type: "text",
                            placeholder: "Escribe el numero de lote del producto",
                            isRequire: false,
                            isDisabled: false,
                            fnChange: setLot_number,
                        }}
                    />
                    <InputsForm
                        DataInputs={{
                            ...
                            value: note || "",
                            type: "text",
                            placeholder: "Escribe una nota del producto",
                            isRequire: false,
                            isDisabled: false,
                            fnChange: setNote,
                        }}
